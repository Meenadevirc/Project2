...
<form:input path="streetname" pattern="[A-Za-z\s]{3,}" title="should not in numbers"/>
...
<form:input path="apartmentnumber" pattern="[A-Za-z0-9,/.-\s]{3,}" title="Should be valid"/>
<form:errors path="apartmentnumber" cssStyle="color:red"></form:errors>
</div>

<div class="form-group">
<form:label path="city">Enter City</form:label>
<form:input path="city" pattern="[A-Za-z\s]{3,}" title="Should be valid"/>
...
<form:input path="country" pattern="[A-Za-z\s]{3,}" title="Should be valid"/>
