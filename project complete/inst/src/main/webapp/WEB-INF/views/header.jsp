...
<ul class="nav navbar-nav navbar-center"><h2>AUDIO JUNGLE...!!Welcomes You..!!!</h2>
   ...
   <c:url value="/home" var="url1"></c:url>
    <li class="active"><a href="home">Home</a></li>
     <c:url value="/aboutus" var="url2"></c:url>
      ...
      <c:url value="/ContactUs" var="url3"></c:url>
      <li><a href="${ url3}">ContactUs</a></li></ul>
...
<security:authorize access="hasRole('ROLE_ADMIN')">     
   ...
   </security:authorize></li><c:url value="/all/registrationform" var="reg"></c:url>
