...
<td><input type="text" id="quantity" class="form-control" maxlength="4" size="4" value="${cartItem.quantity }" min="1" max="100"></td>
...
</div><br><br><br><br><br><%@include file="footer.jsp" %> 
</body>
</html>