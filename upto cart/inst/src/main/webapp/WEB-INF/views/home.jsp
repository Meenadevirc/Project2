...
<div class="container-fluid">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <c:url value="resources\images\home\m2.jpg" var="img2"></c:url>
        <img src="${img2 }" alt="Piano collections" style="width:100%">
      </div>
    
           
      <div class="item">
      <c:url value="resources\images\home\m3.jpg" var="img3"></c:url>
...
<c:url value="resources\images\home\m4.jpg" var="img4"></c:url>
  ...
  <div class="container-fluid">
  <h2 align="center">INSTRUMENT COLLECTIONS</h2>
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
